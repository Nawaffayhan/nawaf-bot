...
const developers = ["444051496083128331"]
...
client.on('message', msg => {
	if (msg.content === 'nhelp') {
	  msg.reply('تم إرسال ألاوامر في الخاص');
	}
  });
...
**
        ...
        ***__General orders__***
**
『nid / معلومات عن حسابك』
『ndraw / يكرر كلامك في صوره』
『nembed / يكرر كلامك بمبيد』
『nroles / يعرض لك الرتب و عددها』
『nrooms / يعرض لك الرومات وعددها』
『nserver / معلومات عن السيرفر』
『nanimal / يعطيك صور حيوانات』
『nimage / يعرض صوره السيرفر』
『navatar / يعرض صورتك او صوره شخص』
『ntime / يعرض لك الوقت』
『ndate / يعرض لك التاريخ』
『ndt / يعرض الوقت في الامارات و مكه المكرمه و مصر و التاريخ』
**

        ***__Bot orders__***
**
『nping / يعرض لك سرعه اتصال البوت』
『nuptime / يعرض لك صار للبوت كم شغال』
『nsupport / سيرفر الدعم القني و المساعده』
『ninvite / اضافه البوت』
『nmembers / حاله الاعضاء』
『nbot / معلومات عن البوت』
**
...
『nmute /ميوت』
『nunmute /فك الميوت』
『nmutechannel /قفل الشات』
『nunmutechannel /فتح الشات』
『nadd.r / اضافه رتبه』
『ndelet / مسح روم』
『ncolor 50 /انشاء 50 لون』
『ncolor 100/انشاء 100 لون』
『ncolor 140/انشاء 140 لوم』
『nct /انشاء روم كتابي』4
『ncv /انشاء روم صوتي』
『nbc /برودكاست』
**
...
『nلعبه مريم / مريم』
『nلعبه خواطر / خواطر』
『nيعطيك شعر عن الحب / حب』
『nيخيرك بين شي وشي / لو خيروك』
『nيعطيك عقاب و لازم تنفذه / عقاب』
『nلعبه اسئله / كت تويت』
**
...
const Sra7a = [
   ...
   client.on('message', message => {
 if (message.content.startsWith('nصراحه')) {
...
message.channel.sendEmbed(cat);
 ...
 client.on('message', message => {
   if (message.content.startsWith("nكت تويت")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL) 
...
const secreT = [
 ...
 client.on('message', message => {
   if (message.content.startsWith("nخواطر")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
...
const Love = [  "**احبك / عدد قطرات المـــطر والشجر وامواج البحر والنجوم الي تتزاحم مبهورة في جمال القمر**.",  "**ساعزفك وساجعلك لحنا تغني عليه جميع قصائد العشــق**.",  "**احبك موت... لاتسألني ما الدليل ارأيت رصاصه تسأل القتيل؟**.",  "**ربما يبيع الانسان شيئا قد شراه لاكن لا يبيع قلبا قد هواه**.",  "**و ما عجبي موت المحبين في الهوى ........... و لكن بقاء العاشقين عجيب**.",   "**حلفت / لاحشـــد جيوش الحب واحتلك مسكين ربي بلاك بعـــاشق ارهـــابي**.",   "**العيــن تعشق صورتك ... والقلب يجري فيه دمك وكل مااسمع صوتك ...شفايفي تقول احبك**.",   "**ياحظ المكان فيك..ياحظ من هم حواليك ...ياحظ الناس تشوفك ... وانا مشتاق اليك**.",   "**لو كنت دمعة داخل عيوني بغمض عليك وصدقي ما راح افتح...ولو كان الثمن عيوني**.",   "**سهل اموت عشانك لكن الصعب اعيش بدونك سهل احبك لكن صعب انساك**.",   "**أخشى ان انظر لعيناك وأنا فى شوق ولهيب لرؤياك**.",   "**أتمنى ان اكون دمعة تولد بعينيك واعيش على خديك واموت عند شفتيك**.",   "**أحياناً أرى الحياة لا تساوى إبتسامة لكن دائماً إبتسامتك هى كيانى**.",   "**من السهل أن ينسى الانسان نفسه .. لكن من الصعب ان ينسى نفساً سكنت نفسه !**.",   "**نفسى أكون نجمة سماك .. همسة شفاك .. شمعة مساك .. بس تبقى معايا وانا معاك**.",   "**أهنئ قلبى بحبك وصبر عينى فى بعدك وأقول إنك نور عينى يجعل روحى فدى قلبك**.", ]
 ...
 client.on('message', message => {
   if (message.content.startsWith("nحب")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL) 
...
client.on('message', message => {
    if (message.content.startsWith("nstats")) {
    message.channel.send({
...
client.on("message", (message) => {
    if (message.content.startsWith('ndelet')) {
        if (!message.member.hasPermission('MANAGE_CHANNELS')) return message.reply("You Don't Have `MANAGE_CHANNELS` Premissions ");
 ...
 **
رابط البوت | http://cutt.us/nawaf-bot
 **
`);
  message.author.sendEmbed(embed);
   }
 ...
 **
رابط السيرفر | https://discord.gg/en5fAgb
 **
`);
  message.author.sendEmbed(embed);
   }
...
client.on('message', message => {
       ...
       if(message.content === prefix + "nmutechannel") {
                           if(!message.channel.guild) return message.reply('** This command only for servers**');
...
//viper
    if(message.content === prefix + "nunmutechannel") {
                        if(!message.channel.guild) return message.reply('** This command only for servers**');
...
if (message.content.startsWith("nadd.r")) {
...
client.on('ready', function(){
    client.user.setStatus("on");
    var ms = 100000 ;
    var setGame = [`nhelp Servers ${client.guilds.size} `,`ninvite Users ${client.users.size}`];
    var i = -1;
    var j = 0;
